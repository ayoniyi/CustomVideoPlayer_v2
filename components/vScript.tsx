  ...
  useEffect(() => {
    ...
    const videoFunctions = () => {
      ...
      if (typeof window !== 'undefined') {
        ...
        const previewImg = document.querySelector(".preview-img") as HTMLImageElement | null
        const thumbnailImg = document.querySelector(".thumbnail-img") as HTMLImageElement | null
        ...
        if (video) {
          ...
          // Play/Pause
          if (playPauseBtn && videoContainer) {
            const togglePlay = () => {
    ...
    // const windowStatus = typeof window
    videoFunctions()
